...
public class Parser {
    ...
    public void advance() {
        if (hasMoreCommands()) {
            String nextLine = scanner.nextLine().trim(); // Trim to remove leading and trailing whitespaces
    ...
    public String arg2() {
        ...
        if (commandType.equals(C_POP) || commandType.equals(C_PUSH) || commandType.equals(C_CALL)
